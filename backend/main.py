...
app.config['SQLALCHEMY_DATABASE_URI']='mysql://root:@localhost/covids'
db=SQLAlchemy(app)
...
def pdetails():
    ...
    print(code)
   # posts=Patientdata.query.filter_by(srfid=code).first()
   #there is no patient data will add it lateer on. The patient data will give you errors so don't click on it
